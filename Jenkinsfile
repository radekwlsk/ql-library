...
// --- github ---
deployLink = "https://ci.10clouds.com/job/ql_library/job/ql_library/parambuild?deploy=true"
gitHubOrgName = "10clouds"
// --- slack ---
slackChannel = "#ql_library-notifications"
            ...
            if(env.CHANGE_ID != null && !params.deploy) {
                def body = [
                    body: """
                        ...
                        - [Deploy](${deployLink}) this change to [DEV](https://ql-library.dev.10clouds.io)
                    """.stripIndent()
                ]
                httpRequest (

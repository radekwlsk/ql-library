...
class Author(models.Model):
    ...
    country = models.CharField(
        _("Author's nationality"), max_length=32, null=True, blank=True
    )
...
class Book(models.Model):
    ...
    language = models.CharField(
        max_length=2, choices=LANGUAGE_CHOICES, default=BookLanguage.EN.name
    )
    pages = models.PositiveSmallIntegerField(null=True, blank=True)
    category = models.CharField(max_length=16, choices=CATEGORY_CHOICES, null=True)
